...
class Pix2PixMaskModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_B', 'fake_B', 'want_B','tort_A','comb_B','mask1','mask2']
        ...
        self.netG = networks.define_G(9, 2, opt.ngf, opt.netG, opt.norm,
...
#            self.optimizers.append(self.optimizer_D)
    ...
    def set_input(self, input,input2,model0):
        ...
        """
        self.model0=model0
        self.model0.set_input(input,input2)
        self.set_requires_grad(self.model0.netG, False)
        with torch.no_grad():
            self.model0.forward(1)
            self.want_B=self.model0.want_B.detach()
...
#        self.real_A = input['A' if AtoB else 'B'].to(self.device)
    ...
    def forward(self,p):
        ...
        self.mask = self.netG(torch.cat( (torch.cat((self.want_B,self.tort_A),1),self.fake_B),1) )  # G(A)
