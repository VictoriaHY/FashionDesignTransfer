...
class Pix2PixComModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN', 'G_perceptual', 'G_L1', 'D1_real', 'D1_fake','D2_real', 'D2_fake']
        # specify the images you want to save/display. The training/test scripts will call <BaseModel.get_current_visuals>
        self.visual_names = ['real_A', 'fake_B', 'real_B','tort_A','low_A']
    ...
    def forward(self,p):
        ...
        self.fake_B,self.tort_A,self.low_A = self.netG(self.real_A,p)  # G(A)
    ...
    def backward_D1(self):
        ...
        pred_real = self.netD1(real_AB.detach())
    ...
    def backward_D2(self):
        ...
        pred_real = self.netD2(real_AB.detach())
    ...
    def backward_G(self):
        ...
        fake_AB1 = torch.cat((self.real_A, self.fake_B), 1)
        pred_fake1 = self.netD1(fake_AB1)
        fake_AB2 = torch.cat((self.tort_A, self.fake_B), 1)
        pred_fake2 = self.netD2(fake_AB2)
        self.loss_G_GAN = self.criterionGAN(pred_fake1, True,0)+self.criterionGAN(pred_fake2, True,0)
        # Second, G(A) = B
        self.loss_G_L1 = self.criterionL1(self.fake_B, self.real_B) * self.opt.lambda_L1 * 0.5
